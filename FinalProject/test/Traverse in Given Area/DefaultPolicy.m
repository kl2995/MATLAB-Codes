function [Win]=DefaultPolicy(Chessboard,CountZeros,rAI,cAI,Leftboundary,Rightboundary,Upperboundary,Lowerboundary,Boundwidth)
if nargin==2
...
while (~End) && sum(sum(CountZeros1))>0
    if move==1
        ...
        End=EndGame(r,c,Chessboard1,CountZeros);
        move=move*(-1);
